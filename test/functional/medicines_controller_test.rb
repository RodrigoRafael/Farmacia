...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { composicao: @medicine.composicao, entrega: @medicine.entrega, nome: @medicine.nome, preco: @medicine.preco, receita: @medicine.receita }
    end
  ...
  test "should update medicine" do
    put :update, id: @medicine, medicine: { composicao: @medicine.composicao, entrega: @medicine.entrega, nome: @medicine.nome, preco: @medicine.preco, receita: @medicine.receita }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
